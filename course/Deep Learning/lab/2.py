...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 22:53:14 2019
...
dataset = pd.read_csv("heart.csv", header=None).values
 #print(dataset)
import numpy as np
...
tensorboard = TensorBoard(log_dir="2qlog2/",histogram_freq=0, write_graph=True, write_images=True)
